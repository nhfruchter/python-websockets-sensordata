# Originally from: 
# https://gist.github.com/tanmaykm/5111225#file-pywebsock-py

# github.com/nhfruchter -
# Added a few improvements for dev purposes, such as start/stop controls
# and custom data processing by subclassing and redefining the process() 
# function.

import socket, hashlib, base64, threading

class PyWSock(object):
	"""Base class that implements a WebSockets server, including broadcast."""
